...
#include "liorf/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const liorf::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<liorf::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  return &liorf::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const liorf::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<liorf::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &liorf::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &liorf::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
