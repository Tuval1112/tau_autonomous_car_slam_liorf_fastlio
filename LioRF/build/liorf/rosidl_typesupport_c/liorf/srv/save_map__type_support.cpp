...
#include "liorf/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _SaveMap_Request_type_support_symbol_names_t _SaveMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liorf, srv, SaveMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liorf, srv, SaveMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_liorf
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, liorf, srv, SaveMap_Request)() {
  return &::liorf::srv::rosidl_typesupport_c::SaveMap_Request_message_type_support_handle;
}
...
static const _SaveMap_Response_type_support_symbol_names_t _SaveMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liorf, srv, SaveMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liorf, srv, SaveMap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_liorf
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, liorf, srv, SaveMap_Response)() {
  return &::liorf::srv::rosidl_typesupport_c::SaveMap_Response_message_type_support_handle;
}
...
static const _SaveMap_type_support_symbol_names_t _SaveMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liorf, srv, SaveMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liorf, srv, SaveMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, liorf, srv, SaveMap)() {
  return &::liorf::srv::rosidl_typesupport_c::SaveMap_service_type_support_handle;
}
