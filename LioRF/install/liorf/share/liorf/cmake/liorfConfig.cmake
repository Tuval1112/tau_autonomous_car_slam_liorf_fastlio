...
if(_liorf_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED liorf_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(liorf_FOUND FALSE)
  elseif(NOT liorf_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(liorf_FOUND FALSE)
  endif()
  return()
endif()
set(_liorf_CONFIG_INCLUDED TRUE)

# output package information
if(NOT liorf_FIND_QUIETLY)
  message(STATUS "Found liorf: 1.0.0 (${liorf_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'liorf' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${liorf_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(liorf_FOUND_AMENT_PACKAGE TRUE)
